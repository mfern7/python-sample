...
<body id="sample">
  <div class="textColumn">
    <h1>W e l c o m e      Marcos !</h1>
    <p>This is my first AWS Elastic Beanstalk Python Application and now is running on your own dedicated environment in the AWS Cloud</p>
  </div>
